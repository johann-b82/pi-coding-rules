...
* **Tagged Commit Standard:** You must always create a corresponding, lightweight Git Tag tracking version/milestone references for **every single commit** you make.
